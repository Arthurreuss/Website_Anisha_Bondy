...
**Stand:** 2026-09-26 · D-039 – D-051 live (D-047 Web-Recherche + Partner-Logos, D-048 Liste gekürzt, D-049 Antworten Anisha); live = Branch `production`, `main` = Arbeitsstand
...
2. Wir: YAMawards-Ergebnis (29.09.) bei Lene eintragen. Flucht: Standbilder/Loop aus dem Trailer (NUGsQ-HoR54) – YouTube blockt den Download im Container (403), User lädt die Datei hoch.
