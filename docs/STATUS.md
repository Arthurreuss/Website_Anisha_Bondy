...
- **Feinschliff** (D-045, D-046): Flicker Karte → Case (GSAP-Rundung, Video-Klon, Klon wie Karten-Ebene), Titelband im Menü. Beides live.

## Laufende Agenten
- keine.

## Nächster Schritt
1. User: Karten-Klick nach Trackpad-Scrollen prüfen (D-046 live).
