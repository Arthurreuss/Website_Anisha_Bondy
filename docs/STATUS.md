...
**Stand:** 2026-09-26 · D-039 – D-050 live, D-051 auf `main` (D-047 Web-Recherche + Partner-Logos, D-048 Liste gekürzt, D-049 Antworten Anisha); live = Branch `production`, `main` = Arbeitsstand
...
- **Feinschliff** (D-045, D-046): Flicker Karte → Case (GSAP-Rundung, Video-Klon, Klon wie Karten-Ebene), Titelband im Menü – live. D-050: Galerie hält beim Karten-Klick an (Ruck nach rechts) – live. D-051: Fenster-Scrollbar ausgeblendet (Rest-Ruck) – noch nicht live.
