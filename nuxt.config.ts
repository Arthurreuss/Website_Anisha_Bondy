...
export default defineNuxtConfig({
  ...
  nitro: {
    prerender: {
      ...
      // /about und /archive sind nicht verlinkt genug, um gecrawlt zu
      // werden, deshalb explizit (P15, ersetzt den ignore-Eintrag aus D-011).
      routes: ['/', '/de', '/about', '/archive', '/de/about', '/de/archive'],
    },
  },
